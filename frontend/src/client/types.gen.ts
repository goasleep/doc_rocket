...
export type ArticleTokenUsageSummary = {
    article_id: string;
    total_tokens: number;
    total_prompt_tokens: number;
    total_completion_tokens: number;
    operation_count: number;
    operations: Array<ArticleTokenUsage>;
};
...
export type TodayStatsResponse = {
    ...
    total_prompt_tokens: number;
    total_completion_tokens: number;
    agent_breakdown: Array<AgentBreakdownItem>;
};
...
export type YesterdayStatsResponse = {
    total_tokens: number;
    total_calls: number;
    total_prompt_tokens: number;
    total_completion_tokens: number;
...
export type TokenUsageGetTodayStatsResponse = (TodayStatsResponse);

export type TokenUsageGetYesterdayStatsResponse = (YesterdayStatsResponse);

export type TokenUsageGetTrendDataData = {
    agentConfigId?: (string | null);
    days?: number;
};

export type TokenUsageGetTrendDataResponse = (Array<TrendDataPoint>);

export type TokenUsageGetAgentStatsData = {
    agentConfigId?: (string | null);
    endDate?: (string | null);
    startDate?: (string | null);
};

export type TokenUsageGetAgentStatsResponse = (Array<AgentStatsResponse>);

export type TokenUsageGetSingleAgentStatsData = {
    agentId: string;
    endDate?: (string | null);
    startDate?: (string | null);
};

export type TokenUsageGetSingleAgentStatsResponse = (Array<AgentStatsResponse>);

export type TokenUsageGetArticleTokenUsageData = {
    articleId: string;
};

export type TokenUsageGetArticleTokenUsageResponse = (ArticleTokenUsageSummary);
