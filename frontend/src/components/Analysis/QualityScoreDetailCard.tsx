...
export function QualityScoreDetailCard({ detail }: QualityScoreDetailCardProps) {
    ...
    <Card className="overflow-hidden">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-base font-medium">{dimensionLabel}</CardTitle>
        ...
        <Progress
          value={detail.score}
          className="h-2"
          // @ts-ignore - className override for indicator
      ...
      <CardContent className="space-y-3 pt-0">
        ...
        {detail.evidences && detail.evidences.length > 0 && (
          <div className="space-y-2">
            <div className="text-xs font-medium text-muted-foreground">评分依据</div>
            <div className="space-y-2">
        ...
        {detail.improvement_suggestions && detail.improvement_suggestions.length > 0 && (
          <div className="space-y-2">
